...
async function showScreen(id){
  // Cerrar modales huérfanos al cambiar de pantalla (detalle dashboard u otros sticky modals)
  var _dashOv = document.getElementById('dash-detail-overlay');
  if(_dashOv && _dashOv.style.display !== 'none'){ _dashOv.style.display = 'none'; }
