...
var INCIDENCIA_TIPOS = {
  ...
  'Recepción SYNCROLAB': [
    ...
    'Error de cobro / TPV',
    'Problema de acceso / acceso no autorizado',
    'Problema con empleados de otros departamentos',
    'Problema con sistema informático de gestión',
    'Incumplimiento de procedimiento',
    'Retraso / disciplina',
    'Accidente / seguridad',
    'Otro'
  ...
  'Entrenadores': [
    ...
    'Seguimiento / evolución pendiente del cliente',
    'Evaluación pendiente',
    'Problema con recepción / sistema',
    'Error en sistema informático',
    'Problema con compañeros de otros departamentos',
    'Incumplimiento de procedimiento',
    'Retraso / disciplina',
    'Otro'
  ],
